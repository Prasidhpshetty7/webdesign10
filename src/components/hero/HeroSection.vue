<template>
  <section class="hero container has-ellipse-curve">
    <div class="hero-content">
      <h1 class="hero__headline">Hey, I'm Prasidh 🖖</h1>
      <p class="hero__description">
        Web Designer and Full-Stack Developer passionate about building modern,
        visually engaging, and user-focused digital experiences.
      </p>
      <SocialMediaIcons />
    </div>
